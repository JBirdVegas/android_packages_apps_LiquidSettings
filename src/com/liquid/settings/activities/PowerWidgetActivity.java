...
public class PowerWidgetActivity extends PreferenceActivity 
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        for(PowerWidgetUtil.ButtonInfo button : PowerWidgetUtil.BUTTONS.values()) {
            ...
            if (PowerWidgetUtil.BUTTON_FLASHLIGHT.equals(button.getId()) &&
                ...
                final int NT_MODE_CDMA_AND_LTE = 8;
                final int NT_MODE_LTE_MODE_ONLY = 11;
                ...
                switch (network_state) {
                    ...
                    case NT_MODE_CDMA_AND_LTE:
                    case Phone.NT_MODE_CDMA_NO_EVDO:
                    case NT_MODE_LTE_MODE_ONLY:
                        break;
                    default:
                        cb.setEnabled(false);
                        break;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        ...
        if (buttonWasModified) {
            PowerWidgetUtil.saveCurrentButtons(
                    this, PowerWidgetUtil.mergeInNewButtonString(
