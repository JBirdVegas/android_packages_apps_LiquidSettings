...
public class LongPressHomeActivity extends PreferenceActivity 
    ...
    public void onResume() {
        ...
        mUseCustomAppPref.setChecked(Settings.System.getInt(getContentResolver(),
                Settings.System.USE_CUSTOM_APP, 0) == 1);
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mUseCustomAppPref) {
            Settings.System.putInt(getContentResolver(), 
                    Settings.System.USE_CUSTOM_APP, 
                mUseCustomAppPref.isChecked() ? 1 : 0);

            if (mUseCustomAppPref.isChecked()) {
                mShowRecentAppsTitlePref.setChecked(false);
                Settings.System.putInt(getContentResolver(), 
                        Settings.System.RECENT_APPS_SHOW_TITLE, 0);
            }
        } else if (preference == mShowRecentAppsTitlePref) {
            Settings.System.putInt(getContentResolver(), 
                    Settings.System.RECENT_APPS_SHOW_TITLE , 
                mShowRecentAppsTitlePref.isChecked() ? 1 : 0);

            if (mShowRecentAppsTitlePref.isChecked()) {
                mUseCustomAppPref.setChecked(false);
                Settings.System.putInt(getContentResolver(), 
                        Settings.System.USE_CUSTOM_APP, 0);
            }
    ...
    public void shortcutPicked(String uri, String friendlyName, boolean isApplication) {
        if (Settings.System.putString(getContentResolver(), 
                Settings.System.SELECTED_CUSTOM_APP, uri)) {
